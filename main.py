...
tl_admin_users = ['nuevoss01',] #Poner aqui los user con acceso permanente
godlist = ['nuevoss01'] #Poner aqui los admin 
    ...
    if '/up' in text:
        ...
        try:
            ...
            await bot.send_file(ev.chat,txtsendname,
                                caption=f'{txtinfo}',
                                thumb='thumb.png',
                                buttons=[Button.url('|ıllıll Ɇł Ᵽɍøfɇsøɍ |ıllıllı','https://t.me/lil_l4chy')])
